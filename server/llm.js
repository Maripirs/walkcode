...
const SYSTEM_PROMPT = [
  ...
  'Keep the whole algorithm to a SMALL number of meaningful steps — about as many as a clean solution needs. Do NOT split one idea into several near-duplicate steps, and do NOT keep drilling into extra edge cases. Once the setup, the main loop/decision, and the returns are covered, set "done":true instead of inventing more questions.',
